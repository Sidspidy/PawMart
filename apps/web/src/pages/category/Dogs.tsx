...
export default function Dogs() {
  ...
  return (
    <div data-theme="dogs" className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)', paddingBottom: '2rem' }}>
      {/* Hero Banner */}
      <section
      ...
      >
        {/* Background elements */}
        <div className="absolute inset-0" style={{ background: 'radial-gradient(circle at top right, rgba(253, 230, 138, 0.3), transparent 60%)', pointerEvents: 'none' }} />
        ...
        <div className="container relative z-10 grid gap-8 md:grid-cols-12 md:items-center" style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div className="md:col-span-7" style={{ textAlign: 'left' }}>
            ...
            >
              ...
              <span>THE ULTIMATE CANINE PARADISE</span>
            </motion.div>
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Tail-Wagging <br />
              <span style={{ color: '#fef3c7' }}>Happiness Guaranteed</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Treat your best friend to delicious wild-caught salmon kibble, premium memory foam orthopedic beds, and chew-resistant rubber toys.
            </motion.p>
      ...
      <section style={{ marginTop: '-1.5rem', position: 'relative', zIndex: 20 }} className="container">
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', borderRight: '1px solid #f3ebe1', paddingRight: '1rem' }} className="sm:border-r-0 md:border-r">
            <div style={{ display: 'flex', height: 48, width: 48, flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: '50%', backgroundColor: '#fffbe5', color: '#d97706' }}>
              <Bone className="h-5 w-5 fill-amber-500 text-amber-500" />
            </div>
            <div style={{ textAlign: 'left' }}>
              <h4 style={{ margin: 0, fontSize: '0.9rem', fontWeight: 800, color: '#2d2418', fontFamily: 'var(--font-display)' }}>100% Dog-Safe Materials</h4>
              <p style={{ margin: 0, fontSize: '0.75rem', color: '#8a7e72', fontWeight: 500 }}>Puncture-resistant rubber & grain-free kibble</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', borderRight: '1px solid #f3ebe1', paddingRight: '1rem' }} className="sm:border-r-0 md:border-r">
            ...
            <div style={{ textAlign: 'left' }}>
              <h4 style={{ margin: 0, fontSize: '0.9rem', fontWeight: 800, color: '#2d2418', fontFamily: 'var(--font-display)' }}>Vet Recommended</h4>
              <p style={{ margin: 0, fontSize: '0.75rem', color: '#8a7e72', fontWeight: 500 }}>Tested and formulated by canine experts</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              <h4 style={{ margin: 0, fontSize: '0.9rem', fontWeight: 800, color: '#2d2418', fontFamily: 'var(--font-display)' }}>Fast 1-Day Delivery</h4>
              <p style={{ margin: 0, fontSize: '0.75rem', color: '#8a7e72', fontWeight: 500 }}>Free shipping on orders above ₹999</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' }}>
          ...
          >
            <div className="absolute right-0 bottom-0 opacity-10" style={{ transform: 'translate(10%, 10%)' }}>
              <Bone style={{ height: 160, width: 160, rotate: '45deg' }} />
            </div>
            <span style={{ display: 'inline-block', borderRadius: 9999, backgroundColor: 'rgba(251, 191, 36, 0.15)', border: '1px solid rgba(251,191,36,0.3)', padding: '4px 12px', fontSize: '0.65rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#fcd34d' }}>
              AGILITY & PLAYTIME
            </span>
            <h3 style={{ marginTop: '1rem', fontFamily: 'var(--font-display)', fontSize: '1.65rem', fontWeight: 900, lineHeight: 1.25 }}>
              BOGO: Durable Rubber Chew Toys
            </h3>
            <p style={{ marginTop: '0.75rem', fontSize: '0.85rem', color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, maxWidth: '22rem' }}>
              Buy 1 and get the second free! Constructed from 100% natural puncture-resistant non-toxic rubber.
            </p>
            <div style={{ marginTop: '1.5rem' }}>
              <Link
                to="/products?category=dogs&subcategory=toys"
                style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.8rem', fontWeight: 800, color: '#fcd34d', textDecoration: 'none' }}
              >
          ...
          >
            ...
            <span style={{ display: 'inline-block', borderRadius: 9999, backgroundColor: 'rgba(254, 215, 170, 0.15)', border: '1px solid rgba(254,215,170,0.3)', padding: '4px 12px', fontSize: '0.65rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#ffedd5' }}>
              JOINT & SLEEP WELLNESS
            </span>
            <h3 style={{ marginTop: '1rem', fontFamily: 'var(--font-display)', fontSize: '1.65rem', fontWeight: 900, lineHeight: 1.25 }}>
              Save 20% on Orthopedic Foam Beds
            </h3>
            <p style={{ marginTop: '0.75rem', fontSize: '0.85rem', color: 'rgba(255,255,255,0.85)', lineHeight: 1.5, maxWidth: '22rem' }}>
              Renders therapeutic support for senior pets. Removable, machine-washable waterproof bolsters.
            </p>
            <div style={{ marginTop: '1.5rem' }}>
              <Link
                to="/products?category=dogs&subcategory=accessories"
                style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.8rem', fontWeight: 800, color: '#ffedd5', textDecoration: 'none' }}
              >
                <span>Shop Beds</span>
                <ChevronRight className="h-4 w-4" style={{ transition: 'transform 200ms ease' }} />
              </Link>
      ...
      <section id="catalog" className="container mt-16" style={{ maxWidth: 1280, margin: '4rem auto 2rem auto', scrollMarginTop: '6rem' }}>
            ...
            {subcategories.map((sub) => (
              <button
                ...
                style={{
                  ...
                  backgroundColor: selectedSub === sub.id ? '#d97706' : '#fff',
                  color: selectedSub === sub.id ? '#fff' : '#4a4036',
                  cursor: 'pointer',
                  boxShadow: selectedSub === sub.id ? '0 4px 10px rgba(217,119,6,0.2)' : '0 1px 2px rgba(0,0,0,0.02)',
                  transition: 'all 200ms ease',
                }}
              >
                {sub.label}
        ...
        {filteredProducts.length > 0 ? (
          ...
          >
            <Bone className="h-16 w-16 text-amber-200 animate-bounce mb-4" />
